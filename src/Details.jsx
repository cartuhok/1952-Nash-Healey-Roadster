...
const Details = () => {
  ...
  const codeBlock1 = `export default function App() {
  ...
  const codeBlock2 = `export default function Scene({ carColor, seatColor, interiorColor, stitchingColor }) {
  ...
  const codeBlock3 = `   // A map that associates each color type with a handler function for updating it
